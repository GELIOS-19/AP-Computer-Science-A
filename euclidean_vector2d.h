...
public:
  ...
  euclidean_vector2d(float magnitude, float angle_of_rotation, directions direction_of_axis, directions direction_of_angle_of_rotation);
  ...
  static directions convert_string_to_directions(std::string direction_string) {
    if (direction_string == "north") return north;
    if (direction_string == "south") return south;
    if (direction_string == "east") return east;
    if (direction_string == "west") return west;
